...
import pickle
import pandas as pd
from utils import make_sens_vector, sens_dict  # Assuming make_sens_vector is defined in fairness module

# Base directory for data files
path_base = os.getcwd()
try:
    os.mkdir(path_base + '/Results')
except:
    pass

try:
    os.mkdir(path_base + 'Results/SavedParams')
except:
    pass
try:
    os.mkdir(path_base + 'Results/Figures')
except:
    pass
...
def process_sens_attributes(task_list, dataset_type):
    ...
    for task in task_list:
        ...
        file_path = f"{path_base}/Input/Dataset/{task}/{dataset_type}.csv"
    ...
    output_file = f"Results/SavedParams/sens_attr_dict_{dataset_type}.pkl"
